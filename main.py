...
def lv1():
    ...
    [c.Enemy(i, 90, enemies, ebullets) for i in range(70, 470, 90)]
    [c.Enemy(i, 120, enemies, ebullets) for i in range(100, 500, 90)]
    [c.Enemy(i, 150, enemies, ebullets) for i in range(130, 530, 90)]
    [c.Base(i, 510, bases) for i in range(40, 550, 110)]
...
def lv2():
    ...
    last_line = c.LastLine()
    ls.add(last_line)
    [c.Enemy2(i, 60, enemies, ebullets) for i in range(100, 500, 130)]
    [c.Enemy(i, 90, enemies, ebullets) for i in range(125, 525, 90)]
    [c.Enemy2(i, 120, enemies, ebullets) for i in range(100, 500, 130)]
    [c.Enemy(i, 150, enemies, ebullets) for i in range(125, 525, 90)]
    [c.Base(i, 510, bases) for i in range(40, 550, 110)]
...
def lv3():
    ...
    [c.Enemy2(i, 120, enemies, ebullets) for i in range(100, 500, 130)]
    [c.Enemy(i, 150, enemies, ebullets) for i in range(125, 525, 90)]
    [c.Enemy3(i, 170, enemies, ebullets) for i in range(125, 525, 90)]
    [c.Base(i, 510, bases) for i in range(40, 550, 110)]
